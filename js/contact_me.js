$(function() {
	//Processing the live preview form
    $("#previewForm input,#previewForm textarea").jqBootstrapValidation({
        preventSubmit: true,
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>The Password is : password </strong>");
                    $('#success > .alert-success')
                        .append('</div>');
					
					window.open('http://www.citilab-thriftlab.herobo.com');
                    //clear all fields
                    $('#previewForm').trigger("reset");
                },
                error: function() {
                    // Fail message
